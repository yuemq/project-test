...
var Zepto = (function () {
  ...
  $.fn = {
    ...
    val: function (value) {
      ...
      }) : (this[0] && (this[0].multiple ? $(this[0]).find("option").filter(function () { return this.selected; }).pluck("value") : this[0].value)
      );
    },
...
// 前面表达式返回false 的时候，执行后面的表达式，这时候windos.$就被赋值成了Zepto
//前面表达式返回true的时候，不会执行后面的表达式
window.$ === undefined && (window.$ = Zepto);